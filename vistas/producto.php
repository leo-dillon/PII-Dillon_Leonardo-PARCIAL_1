    ...
    <div>
        ...
        <div class="contenedorComentarios">
            ...
            <div>
                ...
                <?php 
                foreach ($producto -> getReviews() as $pro) {
                    // Funciones::mostrar($pro -> comment);
                    echo Funciones::generarComentario( $pro -> rating, $pro -> reviewerName, $pro -> date, $pro -> reviewerEmail, $pro -> comment );
                }
                ?>
            </div>
        </div>
